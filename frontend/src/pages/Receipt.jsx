...
export default function Receipt() {
    ...
    const handleDownloadPdf = async () => {
        ...
        try {
            ...
            a.href = url;
            a.download = `FUOYE_Receipt_${receipt?.hms_reference?.replace(/\//g, '-') || 'receipt'}.pdf`;
            ...
            <div className="max-w-2xl mx-auto animate-in fade-in duration-300 space-y-6">
                <div className="flex items-center justify-between animate-pulse">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="h-10 w-24 bg-surface-2 rounded-full" />
                    </div>
                </div>
                <div className="bg-white rounded-3xl shadow-sm border border-black/5 overflow-hidden animate-pulse">
                    ...
                    <div className="p-8 space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {[1,2,3,4,5,6].map(i => <div key={i} className="h-12 bg-surface-2 rounded-xl" />)}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    return (
        <div className="max-w-2xl mx-auto animate-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Receipt Card */}
            <div ref={printRef} className="bg-white rounded-3xl shadow-sm border border-black/5 overflow-hidden print:shadow-none print:border-0 print:rounded-none" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
                {/* Header */}
                <div className="bg-forest p-8 text-center">
                    <h1 className="text-3xl font-serif font-black text-white tracking-tighter">FUOYE</h1>
                    <p className="text-white/50 text-sm font-medium mt-1">Hostel Management Portal</p>
                ...
                <div className="p-8 space-y-6">
                    ...
                    <div className="text-center py-4 bg-lime-soft border border-lime-border rounded-2xl">
                        <p className="text-xs font-bold text-muted uppercase tracking-widest">Payment Reference</p>
                    ...
                    <div className="text-center pt-4 border-t border-black/5">
                        ...
                        <p className="text-xs text-muted font-medium mt-1">Generated by FUOYE Hostel Management Portal</p>
                    </div>
                </div>
            </div>
